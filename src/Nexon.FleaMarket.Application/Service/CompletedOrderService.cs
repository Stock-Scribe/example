...
public class CompletedOrderService: IGetCompletedOrderUseCase
{
    private readonly ICompletedOrderPort _completedOrdersPort;
    public CompletedOrderService(ICompletedOrderPort completedOrdersPort)
    {
        _completedOrdersPort = completedOrdersPort;
    }
    public async Task<ApiResponse<GetCompletedOrdersResponse>> GetCompletedOrdersAsync(GetCompletedOrdersRequest request)
    {
        ...
        return await _completedOrdersPort.GetCompletedOrdersAsync(request);
    }
}